...
| 20   | [Name difference between copying primitive and object ( reference ) ? explain why let a = {};let b = {} not equal objects. Same arr1 = [1, 2], arr2 = [1,2] ( it's also not  same objects-arrays ) (#object-primitive-reference)                                     |
