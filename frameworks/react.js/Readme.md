...
| Nm | #Question   |
| :---:   | :---: |
| 1   | [1. What for is used useEffect? When useEffectIsCalled? 3. Diff between useEffect and useLayoutEffect? 4. Lifecycle phases of useEffect? ](#react-useEffect)                               |
...
doesn't have it.
4. <img width="593" height="129" alt="image" src="https://github.com/user-attachments/assets/9d167758-0a08-405a-9d31-172c82bc6f75" />
